...
function check(){
    ...
    if(ck == true){
        document.getElementById("tableDiv").innerHTML = "Congradulations, you have solved the puzzle. You have used "+ timeString + " to complete this puzzle with "+ stepCount +" moves."; 
