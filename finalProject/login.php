...
if(isset($_SESSION['user'])!="")
{
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown" id = "new">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"> Log in&nbsp;</span><span class="caret"></span>
						</a>
						<ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
						  <li><a href="signup.html">Sign up</a></li>
						  
						  <li class="dropdown-submenu">
							<a tabindex="-1" href="#">Log in</a>
							<ul class="dropdown-menu">
							  <li><a tabindex="-1" href="Adminpage.html">Admin</a></li>
	...
	<div class="container" id="homepage">
		<h1>Opps</h1>
		<p>Wrong username or wrong password, <a href="customersignin.html">try it again!</a></p>
	</div>
